...
type CharacterClassConnection {
  ...
  aggregate: AggregateCharacterClass!
}
...
input CharacterClassScalarWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  level_gt: Int
  level_gte: Int
  AND: [CharacterClassScalarWhereInput!]
  OR: [CharacterClassScalarWhereInput!]
  NOT: [CharacterClassScalarWhereInput!]
}

type CharacterClassSubscriptionPayload {
...
input CharacterClassSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: CharacterClassWhereInput
  AND: [CharacterClassSubscriptionWhereInput!]
  OR: [CharacterClassSubscriptionWhereInput!]
  NOT: [CharacterClassSubscriptionWhereInput!]
}
...
input CharacterClassUpdateOneInput {
  create: CharacterClassCreateInput
  update: CharacterClassUpdateDataInput
  upsert: CharacterClassUpsertNestedInput
  delete: Boolean
  disconnect: Boolean
  connect: CharacterClassWhereUniqueInput
}
...
input FeatureCreateInput {
  ...
  fromClass: CharacterClassCreateOneInput
}
...
input FeatureUpdateDataInput {
  ...
  fromClass: CharacterClassUpdateOneInput
}
...
input FeatureWhereInput {
  ...
  fromClass: CharacterClassWhereInput
...
type Mutation {
  ...
  createCharacterClass(data: CharacterClassCreateInput!): CharacterClass!
  updateCharacterClass(data: CharacterClassUpdateInput!, where: CharacterClassWhereUniqueInput!): CharacterClass
  updateManyCharacterClasses(data: CharacterClassUpdateManyMutationInput!, where: CharacterClassWhereInput): BatchPayload!
  upsertCharacterClass(where: CharacterClassWhereUniqueInput!, create: CharacterClassCreateInput!, update: CharacterClassUpdateInput!): CharacterClass!
  deleteCharacterClass(where: CharacterClassWhereUniqueInput!): CharacterClass
  deleteManyCharacterClasses(where: CharacterClassWhereInput): BatchPayload!
...
type Query {
  ...
  characterClass(where: CharacterClassWhereUniqueInput!): CharacterClass
  characterClasses(where: CharacterClassWhereInput, orderBy: CharacterClassOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [CharacterClass]!
  characterClassesConnection(where: CharacterClassWhereInput, orderBy: CharacterClassOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): CharacterClassConnection!
...
type Subscription {
  ...
  characterClass(where: CharacterClassSubscriptionWhereInput): CharacterClassSubscriptionPayload
